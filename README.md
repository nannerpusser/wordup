...
- Handles all digrams, doubleletters, either/or tiles, prefix and suffix tiles of each type (**- and ***-, or vice versa). 
- Sorted return based on length
- Absolutely no tile scoring because that was Hard Mode and it's the weekend
